...
GPT2_MEDIUM_CONFIG = dict(
    activation_function="gelu_new",
    architectures=[
        "GPT2LMHeadModel"
    ],
    #attn_implementation="flash_attention_2",  # Use Flash Attention 2 for faster attention
    attn_implementation="sdpa",  # Use PyTorch 2.0 optimized attention (Flash Attention compatible)
    #torch_dtype="bfloat16",  # Required for Flash Attention 2
    attn_pdrop=0.0,  # Disable dropout for inference
    bos_token_id=50256,
    embd_pdrop=0.0,  # Disable dropout for inference
    eos_token_id=50256,
    initializer_range=0.02,
    ...
    resid_pdrop=0.0,  # Disable dropout for inference
