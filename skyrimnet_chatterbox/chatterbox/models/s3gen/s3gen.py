...
class S3Token2Mel(torch.nn.Module):
    ...
    @property
    def estimator_dtype(self):
        return self.flow.decoder.estimator.dtype
    ...
    def forward(
        ...
        n_timesteps = n_cfm_timesteps if n_cfm_timesteps is not None else (2 if self.meanflow else 10)
...
class S3Token2Wav(S3Token2Mel):
    ...
    def flow_inference(
        ...
        noised_mels: torch.Tensor = None,
        speech_token_lens: torch.Tensor = None,
    ):
